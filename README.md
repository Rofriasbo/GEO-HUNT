# GEO-HUNT
¡Entendido\! Aquí tienes el contenido del archivo `dependencias.md` con formato Markdown limpio y detallado para subir a GitHub.
...
| | `flutter_local_notifications` | `^19.5.0` | Muestra notificaciones en primer y segundo plano. |
...
En la raíz del proyecto (`rofriasbo/geohunt/geohunt-main`):
...
➡️ **`rofriasbo/geohunt/geohunt-main/android/app/src/main/AndroidManifest.xml`**

| Permiso | Descripción y Justificación |
| :--- | :--- |
| `ACCESS_FINE_LOCATION` | **Ubicación GPS precisa** (vital para el juego y el geofencing). |
